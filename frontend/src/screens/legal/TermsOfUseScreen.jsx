  ...
  return (
    <>
      ...
      >
        ...
        <br />
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          Before you proceed to use our website, we kindly ask you to carefully
          review and understand the following Terms of Use. By accessing or
          using our website, you agree to be bound by these terms and
          conditions.
        </Row>
        <br />
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          <b style={{ marginLeft: "-10px" }}>1. Acceptance of Terms:</b>
        ...
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          ...
          <p style={{ marginLeft: "-10px", marginTop: "10px" }}>
            ...
            platform to facilitate informed decision-making.
          </p>
        </Row>
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
        ...
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          <b style={{ marginLeft: "-10px" }}>5. User Accounts: </b>
          <p style={{ marginLeft: "-10px", marginTop: "10px" }}>
            Some features of our website may require users to create an account.
            Users are responsible for maintaining the confidentiality of their
            account credentials and for all activities that occur under their
            account. Users agree to provide accurate and complete information
            when creating an account and to promptly update any information that
            may change.{" "}
          </p>
        </Row>
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
        ...
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          <b style={{ marginLeft: "-10px" }}>10. Governing Law: </b>
          <p style={{ marginLeft: "-10px", marginTop: "10px" }}>
        ...
        <Row style={{ fontSize: "20px", fontWeight: "none", margin: "5px" }}>
          <b style={{ marginLeft: "-10px" }}>12. Contact Information: </b>
          <p style={{ marginLeft: "-10px", marginTop: "10px" }}>
